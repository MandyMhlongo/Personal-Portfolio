...
export const PhoneIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.213-.992-.58-1.358l-3.976-3.976c-.367-.367-.842-.58-1.358-.58h-1.372c-.516 0-.992.213-1.358.58l-2.47 2.47a.75.75 0 0 1-1.06 0l-2.47-2.47a.75.75 0 0 1 0-1.06l2.47-2.47c.367-.367.58-.842.58-1.358V6.75a2.25 2.25 0 0 0-2.25-2.25H2.25Z" />
    </svg>
);
